...
var handlebars = require('istanbul/node_modules/handlebars'),
    ...
    fs = require('fs'),
    util = require('util'),
    FileWriter = require('istanbul/lib/util/file-writer'),
    Report = require('istanbul/lib/report/index'),
    Store = require('istanbul/lib/store'),
    InsertionText = require('istanbul/lib/util/insertion-text'),
    TreeSummarizer = require('istanbul/lib/util/tree-summarizer'),
    utils = require('istanbul/lib/object-utils'),
...
Report.mix(HtmlReport, {
    ...
    fillTemplate: function (node, templateData) {
        ...
        templateData.jquery = {
        	js: linkMapper.asset(node, 'jquery.min.js')
        };
        templateData.scrollTo = {
        	js: linkMapper.asset(node, 'jquery.scrollTo.min.js')
        };
        templateData.simpleMinimap = {
            js: linkMapper.asset(node, 'simpleMinimap.js'),
            css: linkMapper.asset(node, 'simpleMinimap.css')
        };
        templateData.minimap = {
        	js: linkMapper.asset(node, 'minimap.js')
        };
    },
    writeDetailPage: function (writer, node, fileCoverage) {
        ...
        writer.write('<div class="console-container"><div class="console-wrapper"><div class="console"><pre><table class="coverage">\n');
        ...
        writer.write('</table></pre></div></div></div>\n');
